...
import com.fanny.freyre.mymathquiz_fannyfreyre.databinding.EasyScoreBinding;
// Easy Level Score Fragment
public class EasyScore extends Fragment {
    // Declare variables
    private EasyScoreBinding binding;

    MediaPlayer finalScoreSE;

    ConstraintLayout easyscoreLayout;

    TextView tv_easyscore, tv_topfive, tv_currentuser;
    ...
    public View onCreateView(
        ...
        binding = EasyScoreBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // Get Views of layout
        easyscoreLayout = binding.easyScoreLayout;
        tv_currentuser = requireView().findViewById(R.id.tv_currentuser);
        tv_easyscore = requireView().findViewById(R.id.tv_easyscore);
        tv_topfive = requireView().findViewById(R.id.tv_topfive);
        btnNewGame = requireView().findViewById(R.id.btnNewGame);

        // Load old users
        SharedPreferences pref = requireActivity().getSharedPreferences("PREFS", 0);
        ...
        tv_easyscore.setText(getString(R.string.last_score, lastScore)); // Display last score
        ...
        binding.btnNewGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(EasyScore.this)
                        .navigate(R.id.action_EasyScore_to_SecondFragment);
            }
        });
    }
}